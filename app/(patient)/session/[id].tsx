      ...
      >
        ...
        <View style={styles.metaRow}>
          <View>
            ...
            <Text style={[styles.time, { color: colors.textSec }]}>
        ...
        {result ? (
          ...
          <Card style={styles.section}>
            <Text style={[styles.noResult, { color: colors.textSec }]}>
        ...
        {vitals && (
          <Card style={styles.section}>
            <Text style={[styles.sectionTitle, { color: colors.text }]}>Recorded Vitals</Text>
            {(
              [
              ...
              .map(([label, value]) => (
                <View key={label} style={[styles.vitalRow, { borderBottomColor: colors.border }]}>
                  <Text style={[styles.vitalLabel, { color: colors.textSec }]}>{label}</Text>
